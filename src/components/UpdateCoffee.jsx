...
const UpdateCoffee = () => {
    ...
    return (
        <div className="bg-[#F4F3F0] p-24" >
            <h2 className="text-3xl text-center font-extrabold mb-6">Update Coffee</h2>
            <form onSubmit={handleUpdateCoffee}>
                ...
                <input type="submit" value="Update Coffee" className="btn btn-block bg-[#D2B48C] hover:bg-[#D2B48C90]" />
